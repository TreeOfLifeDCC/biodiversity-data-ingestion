...
def run(argv):
    ...
    parser.add_argument("--min_batch_size", type=int, default=50, help="Beam minimum batch size")
    parser.add_argument("--max_batch_size", type=int, default=200, help="Beam maximum batch size")
