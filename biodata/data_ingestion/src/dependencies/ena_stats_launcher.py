"""
Launches the ENA stats pipeline by passing its specific command line arguments.
"""
import argparse

from dependencies.ena_stats_pipeline import ena_stats_pipeline
...
def run(argv):
    ...
    parser.add_argument("--ena_api_delay_seconds", default=0.0, type=float)
